...
if (!$dbh) exit("No connection to DB");
if (!isset($_POST['trans_exit']) && !isset($_POST['trans_save'])) $_SESSION['trans_codes'] = GetLocalCodes($dbh, 2);
elseif (isset($_POST['trans_exit'])) exit("END");
