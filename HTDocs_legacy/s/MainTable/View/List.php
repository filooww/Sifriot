...
if (! $dbh) {
    ExitSession(Title(1).' <b>'.$_SESSION['db_info']['db_conn']['db_name'].'</b>`'.implode('`', $Mes).'|FF0000', $_SESSION['db_info']['id']);
}
...
if (GetUpdateFlag($dbh) == 1 && (isset($_POST['u_id']))) {
    ...
    ExitSession(Title(53), (int) $_SESSION['db_key']);
}
if (count($_POST) == 0) {

    InitUserSettings($dbh, (int) $_SESSION['login']['id']);
    GetUserSettings($dbh, (int) $_SESSION['login']['id']);
...
foreach ($_POST as $str_key => $str_v) {
    ...
    switch ($s_k) {
        ...
        case 'list_height_b':	ChangeMTScreenHeight($dbh, $_POST['list_height_v'], $_SESSION['mes']['m'], (int) $_SESSION['user_id']);
            break;
        case 'match_case_find':	$_SESSION['item_arr'] = ChangeMatchCase($dbh, (int) $_SESSION['user_id']);
            break;
        case 'hide_list_flag':	$_SESSION['hide_list'] = ! $_SESSION['hide_list'];
            break;
        case 'sort_find':	SortFind();
            break;
        case 'multi_col':	ChangeColumnsView($dbh, $_SESSION['m_col_v'], $_SESSION['f_view'], $_SESSION['p_code'], $_SESSION['URL_p'], (int) $_SESSION['login']['id'], $_SESSION['p_files']['e'], $_SESSION['PR']['con']);
            break;
        case 'item_beg':	MTNavigation($dbh, 'beg', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'item_pg_up':	MTNavigation($dbh, 'pgup', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'item_ln_up':	MTNavigation($dbh, 'lnup', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'item_ln_dn':	MTNavigation($dbh, 'lndn', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'item_pg_dn':	MTNavigation($dbh, 'pgdn', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'item_end':	MTNavigation($dbh, 'end', $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], (int) $_SESSION['login']['id']);
            break;
        case 'view_item':	ViewItem($dbh, $_SESSION['URL_p'], $_SESSION['f_view'], $_SESSION['p_code'], (int) $arr_key[1], $_SESSION['p_files']['e'], (int) $_SESSION['login']['id'], $_SESSION['PR']['con']);
            break;
        case 'sel_lang':	SetLanguage($dbh, $_POST['view_language'], $_SESSION['langs'], (int) $_SESSION['login']['id'], $_SESSION['cur_lang'], $_SESSION['el_titles']);
            break;
        default:	$sw_break = false;
    }
    $sw_cat_break = ListSettingActions($dbh, $arr_key, $_SESSION, $_SESSION['mes']['m'], (int) $_SESSION['login']['id']);
    if ($sw_cat_break) {
        break;
    }
}
...
<form method="post">
	<input type="hidden" name="u_id" value="<?php echo (string) (int) $_SESSION['login']['id']; ?>"/>
...
if ($_SESSION['set_pad']) {
    ListSettingsPad((int) $_SESSION['login']['id']);
}
