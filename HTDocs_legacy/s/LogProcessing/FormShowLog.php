...
<?php
    if (isset($_SESSION['conf']['upload_log'])) {
        if (file_exists($_SESSION['conf']['upload_log'])) {
            ...
            if ($log_file === false) {
                echo "<div align='center'><h3><<< Failure on file opening >>></h3></div>";
            } else {
                $fl = false;
                if ($log_file) {
                ...
                if (! $fl) {
                    echo "<div align='center'><h3><<< Log is empty >>></h3></div>";
                }
            }
        } else {
            echo "<div align='center'><h3><<< Log file not exists >>></h3></div>";
        }
    } else {
        echo "<div align='center'><h3><<< Log is not determined >>></h3></div>";
    }
