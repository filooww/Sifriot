        ...
        <div class="flex-1 flex overflow-hidden relative">
            ...
            >
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div>
                        <span class="text-xs uppercase tracking-wider text-gray-500">{{ __('Publishers') }}</span>
                        <div class="space-y-1.5 mt-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ $publisher->website }}" target="_blank" rel="noopener" class="text-blue-500 hover:text-blue-600 dark:text-blue-400">
