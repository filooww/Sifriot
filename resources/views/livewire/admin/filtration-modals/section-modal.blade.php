        ...
        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-700">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    {{ $editingSection ? __('Edit Section') : __('Create Section') }}
                </h3>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-4 dark:border-gray-700 dark:bg-gray-900/30">
                        ...
                        <div class="grid gap-4 sm:grid-cols-3">
                            {{-- Name EN --}}
                            <div>
                                <label for="section_name_en" class="mb-1.5 block text-xs font-medium text-gray-600 dark:text-gray-400">
                                    {{ __('English') }} <span class="text-red-500">*</span>
                                </label>
                                <input type="text" wire:model="section_name_en" id="section_name_en"
                                       x-on:input="$wire.section_slug = $event.target.value.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '')"
                                ...
                                @error('section_name_en') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                            </div>

                            {{-- Name RU --}}
                            <div>
                                <label for="section_name_ru" class="mb-1.5 block text-xs font-medium text-gray-600 dark:text-gray-400">
                                    {{ __('Russian') }}
                                </label>
                                <input type="text" wire:model="section_name_ru" id="section_name_ru"
                                       class="block w-full rounded-lg border-gray-300 bg-white text-sm shadow-sm transition focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-400 dark:focus:ring-blue-400">
                                @error('section_name_ru') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                            </div>

                            {{-- Name HE --}}
                            <div>
                                <label for="section_name_he" class="mb-1.5 block text-xs font-medium text-gray-600 dark:text-gray-400">
                                    {{ __('Hebrew') }}
                                </label>
                                <input type="text" wire:model="section_name_he" id="section_name_he" dir="rtl"
                                       class="block w-full rounded-lg border-gray-300 bg-white text-sm shadow-sm transition focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-400 dark:focus:ring-blue-400">
                                @error('section_name_he') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Slug --}}
                    <div>
                        <label for="section_slug" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                            <span class="flex items-center gap-1.5">
                                <x-heroicon-o-link class="h-4 w-4" />
                                {{ __('Slug') }} <span class="text-red-500">*</span>
                            </span>
                        </label>
                        <input type="text" wire:model="section_slug" id="section_slug"
                        ...
                        @error('section_slug') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        {{-- Parent Section --}}
                        <div>
                            <label for="section_parent_id" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                <span class="flex items-center gap-1.5">
                                    <x-heroicon-o-folder class="h-4 w-4" />
                                    {{ __('Parent Section') }}
                                </span>
                            </label>
                            <select wire:model="section_parent_id" id="section_parent_id"
                            ...
                            @error('section_parent_id') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                        </div>

                        {{-- Sort Order --}}
                        <div>
                            <label for="section_sort_order" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                <span class="flex items-center gap-1.5">
                                    <x-heroicon-o-arrows-up-down class="h-4 w-4" />
                                    {{ __('Sort Order') }}
                                </span>
                            </label>
                            <input type="number" wire:model="section_sort_order" id="section_sort_order" min="0"
                                   class="block w-full rounded-lg border-gray-300 bg-white text-sm shadow-sm transition focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-blue-400 dark:focus:ring-blue-400">
                            @error('section_sort_order') <span class="mt-1 text-xs text-red-500 dark:text-red-400">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
