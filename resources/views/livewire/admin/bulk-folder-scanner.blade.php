<div class="max-w-7xl mx-auto py-8 px-4" wire:poll.2s="refreshProgress">
    <h1 class="text-3xl font-bold mb-8 text-gray-900 dark:text-gray-100">{{ __('Bulk Folder Scan') }}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <!-- Sidebar: Folder Tree Navigation (1 column) -->
        <div class="lg:col-span-1">
            @livewire('admin.folder-tree-navigation')
        </div>

        <!-- Main Content: Scan Form and Progress (3 columns) -->
        <div class="lg:col-span-3">
            ...
            @if (!$currentScanJob || in_array($currentScanJob->status, ['completed', 'cancelled', 'failed']))
                <div class="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="maxDepth">
