                    ...
                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <div class="font-medium">{{ $category->name_en }}</div>
                                    @if($category->name_ru)
                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ $category->name_ru }}</div>
                                    @endif
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                            @if($category->parent?->localizedName)
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('No categories found.') }}</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
