            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                @forelse($genres as $genre)
                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-600 dark:text-gray-300" dir="rtl">
                            {{ $genre->name_he ?? '-' }}
                        </td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <button wire:click="deleteGenre({{ $genre->id }})"
                                        wire:confirm="{{ __('Are you sure you want to delete this genre?') }}"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center gap-2">
                                <x-heroicon-o-bookmark class="h-12 w-12 text-gray-300 dark:text-gray-600" />
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('No genres found.') }}</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
