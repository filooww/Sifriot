...
CREATE TABLE `algorithms` (
  ...
  `beg_limit_set` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `beg_number` int(3) NOT NULL DEFAULT '0',
  `beg_inc` int(1) NOT NULL,
  `beg_scr` int(1) NOT NULL,
  `inner_limit_set` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `end_limit_set` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
