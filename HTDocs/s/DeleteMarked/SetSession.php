...
function InitConfig($dbh)
{
	...
	$_SESSION['conf']['portion_item'] = (integer)GetConfigValue($dbh, "db_configs", "portion_item", true, "Number of records reading from the publications at one time", "100");
...
{
	InitConfig($dbh);
	$_SESSION['PR'] = ReadFieldDefinition($dbh, array(), array(), "delmark", $_SESSION['db_info']['t_main']);
