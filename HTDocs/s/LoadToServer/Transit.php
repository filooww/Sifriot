...
<?php  
session_start();
if (isset($_POST['repeate'])) header("Location: FileSelection.php");
elseif (isset($_POST['exit'])) header("Location: ../".$_SESSION['main_return_point']);
?>
...
<form method="post">
	<?php
	if (count($_SESSION['trans_mess']) == 0) echo "<p align='center'><font size='4' color='#FF0000'><b>".$_SESSION['mestext']."</b></font></p>";
	else foreach ($_SESSION['trans_mess'] as $v) echo "<p align='center'><font color='#FF0000'><b>".$v."</b></font></p>";
	?>
	<p class="row_invisible" align="center">S</p>
	<p class="row_invisible" align="center">S</p>
	<p align="center">
