<table>
	<tr>
		<?php if ($_SESSION['user_working_mode'] == 1) echo "<td align='center'>".ImgV("Edit", 18, 16)."</td>";?>
	...
	for ($i = count($_SESSION['user_list']); $i < $_SESSION['portion']; $i++) echo (($_SESSION['user_working_mode'] == 0) ? "" : "<tr><td></td><td>")."</td><td align='right' class='dis_text'>".(string)($i + 1)."</td></tr>";
	?>
</table>
