...
foreach (array_keys($_POST) as $str_key)
{
	...
	switch ($str_key)
	{
	    ...
	    case "tables_s"    : AfterSelectTableList($sw_break); break;
		case "file_export" : ExportToFile($Mes); break;
...
//    {
        ...
        echo "<br>Choose database : "; SelectTag("db", $_SESSION['db_list'], $_SESSION['db'], "db_list_s", false, "", "db_list_on");
        echo "<hr align='left' size='1' noshade='noshade' color='#000000' >";
        echo "<br>Choose table (if necessary) : "; SelectTag("table", $_SESSION['table_list'], $_SESSION['table'], "tables_s", false, "", "tables_on");
//    }
    if ($Mes[0] > 0)
    {
        echo "<hr align='left' size='1' noshade='noshade' color='#000000' >";
