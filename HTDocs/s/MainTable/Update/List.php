...
if (!$dbh) ExitSession(Title(1)." <b>".$_SESSION['S']['arr_db'][$_SESSION['db_key']]['db_name']."</b>`".implode("`", $Mes)."|FF0000", (integer)$_SESSION['db_key']);
...
foreach ($_POST as $str_key => $str_v)
{
	...
	switch ($s_k)
	{
		case "db_exit":			SetUpdateFlag($dbh, 0); ExitSession("", (integer)$_SESSION['db_key']); break;
		case "db_create":		ItemCreate($dbh); header("Location: PubForm.php"); break;
		...
		case "match_case_find":	$_SESSION['item_arr'] = ChangeMatchCase($dbh); break;
		case "hide_list_flag":	$_SESSION['hide_list'] = !$_SESSION['hide_list']; break;
		case "sort_find":		SortFind(); break;
		case "item_config":		$_SESSION['return_point'] = "/List.php"; header("Location: ../../Configuration/PreForm.php"); break;
		case "cat_system":		$_SESSION['return_point'] = "/List.php"; header("Location: ../../Catalogs/MainForm.php"); break;
		case "multi_col":		$_SESSION['m_col_v'] = !$_SESSION['m_col_v']; break;
		case "item_beg":		MTNavigation($dbh, "beg", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "item_pg_up":		MTNavigation($dbh, "pgup", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "item_ln_up":		MTNavigation($dbh, "lnup", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "item_ln_dn":		MTNavigation($dbh, "lndn", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "item_pg_dn":		MTNavigation($dbh, "pgdn", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "item_end":		MTNavigation($dbh, "end", $_SESSION['db_info']['t_main'], $_SESSION['conf']['portion_item'], $_SESSION['p_count'], $_SESSION['p_start'], $_SESSION['item_arr'], $_SESSION['PR'], $_SESSION['p_code'], 0, $pvm); break;
		case "mark_item":		$_SESSION['item_mark_del_question'] = true; $_SESSION['p_code'] = (integer)$arr_key[1]; break;
		case "yes_mark":		PubMarkDelete($dbh, $_SESSION); break;
		case "no_mark":			break;
		case "sel_view":		SetViewMode($dbh, $_SESSION, $_POST['view_mode']); break;
		case "edit_item":		EditCopyItem($dbh, (integer)$arr_key[1], $_SESSION); header("Location: PubForm.php"); break; //???
		case "copy_item":		EditCopyItem($dbh, (integer)$arr_key[1], $_SESSION); header("Location: PubForm.php"); break; //???
		case "this_item":		$_SESSION['p_code'] = (integer)$arr_key[1]; break;
...
<form method="post">
	...
	if ($_SESSION['set_pad']) ListSettingsPad();
